...
?>
        ...
        <main>
            ...
            <section class="banner__inner-page bg-image pt-180 pb-180 bg-image" data-background="assets/images/banner/banner-inner-page.jpg">
                ...
                <div class="container">
                    <h2 class="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">Sobre Nosotros</h2>
                        ...
                        <div class="col-xl-6 wow fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="about-two__left-item">
                                ...
                                <div class="shape-halper">
                                    <img class="sway__animation" src="assets/images/shape/about-circle-helper.png" alt="shape">
                                </div>
                              ...
                              <img src="assets/images/about/about-image2.png" alt="image">
                                ...
                                <div class="circle-shape">
                                    <img class="animation__rotate" src="assets/images/shape/about-two-circle.png" alt="shape">
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6">
                            <div class="section-header mb-40">
                                <h5 class="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                                    <img class="me-1" src="assets/images/icon/section-title.png" alt="icon"> QUIENES SOMOS
                            
                                </h5>
                                <h2 class="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">El mejor centro de enseñanza de matematicas </h2>
                                <p class="wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">Somos una organización sin fines de lucro con la misión de ofrecer educación
                                      de primer nivel, para cualquier persona en cualquier lugar..</p>
                            </div>
                            ...
                            <div class="d-flex gap-2 align-items-center">
                                ...
                                <div class="info">
                                    <h5>Jhoel Ayala</h5>
                                    <span class="sm-font">Director</span>
                                </div>
                            </div>
                        </div>
                        </div>
