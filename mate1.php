...
<head>
    ...
    <title>Matemáticas Primaria</title>
    <!-- Favicon img -->
...
?>
    ...
    <main>
        ...
        <section class="banner__inner-page bg-image pt-180 pb-180 bg-image"
            data-background="assets/images/banner/portada.jpg">
            ...
            <div class="container">
                <h2 class="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">Matemáticas Primaria</h2>
                <div class="breadcrumb-list wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <a href="index.php">Inicio</a><span><i class="fa-regular fa-angles-right mx-2"></i>Matemáticas Primaria</span>
                </div>
            </div>
        </section>
        <!-- Page banner area end here -->
                             <div class="banner-three__info wow fadeInUp mt-50" data-wow-delay="600ms"data-wow-duration="1500ms">
            ...
            <div class="container">
                <div class="row g-4">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-two__item">
                            <div class="image">
                                <img src="assets/images/service/2grado.jpg" alt="image">
                            </div>
                            <div class="service-two__content">
