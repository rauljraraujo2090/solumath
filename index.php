                ...
                <div class="container">
                    <div class="section-header text-center mb-60">
                        <h5 class="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <img class="me-1" src="assets/images/icon/section-title.png" alt="icon">PARA CADA ESTUDIANTE
                    
                        </h5>
                        <h2 class="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">Cada Salón De Clases. Resultados Reales.
                    </h2>
                    </div>
                    <div class="row g-4">
                        ...
                        <div class="row g-4 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                            <div class="col-md-12">
                                <div class="about__right-item">
                                    ...
                                    <div class="content">
                                        <h4 class="mb-1">Aprendizaje personalizado</h4>
