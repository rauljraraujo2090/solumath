                    ...
                    <div class="col-lg-6">
                        <div class="contact__right-item">
                            <div class="section-header mb-20">
                                ...
                                <h2 class="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">¿Listo Para Comenzar?</h2>
                                ...
                                <form  action="" method="POST">
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <input id="nombre" name="nombre" class="bg-transparent bor" type="text"
                                                placeholder="Su nombre">
                                        </div>
                                        <div class="col-6">
                                            <label for="email">Sus Apellidos*</label>
                                            <input class="bg-transparent bor" name="apellido"id="apellido" type="text"
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <input id="celular"name="celular" class="bg-transparent bor" type="number"
                                                placeholder="Su Numero de Celular">
                                        </div>
                                        <div class="col-6">
                                            <label for="email">Tu correo electrónico*</label>
                                            <input class="bg-transparent bor" name="correo"id="correo" type="email"
                                    ...
                                    <div class="text-area">
                                        ...
                                        <textarea class="bg-transparent bor" name="sms"id="sms"type="text"
