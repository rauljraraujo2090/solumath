        ...
        <main>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="container">
                                <div class="banner__content">
                                    ...
                                    <h1 data-animation="slideInRight" data-duration="2s" data-delay=".5s" class="text-white">Excellent It Services
                                    for Your Success
                                </h1>
                                    ...
                                    <br>quisque eget congue
                                    velit
                                    in cursus leo sed
                                    sodales est eget turpis.
                                
                                    </p>
                                    <a data-animation="slideInRight" data-duration="2s" data-delay=".9s" href="about.html" class="btn-one mt-60">
                                        Explore
                                    More <i class="fa-regular fa-arrow-right-long"></i>
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="d-flex flex-wrap gap-4 align-items-center justify-content-between mb-60">
                        <div class="section-header">
                            <h5 class="wow fadeInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
                                <img class="me-1" src="assets/images/icon/section-title.png" alt="icon">What We OFFER
                        
                            </h5>
                            <h2 class="wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">Excellent It
                            Services</h2>
                        </div>
                        <a href="service.html" class="btn-one wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                            View All
                                ...
                                <div class="image sm-image">
                                    <div class="video__btn-wrp">
                                        <div class="video-btn video-pulse">
                                            <a class="video-popup" href="https://www.youtube.com/watch?v=iVqz_4M5mA0">
                        ...
                        <div class="col-xl-6">
                            <div class="section-header mb-40">
                                <h5 class="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                                    <img class="me-1" src="assets/images/icon/section-title.png" alt="icon">ABOUT Gratech
            ...
            <section class="case-area pt-120 pb-120">
                <div class="container">
                    <div class="d-flex flex-wrap gap-4 align-items-center justify-content-between mb-60">
                        <div class="section-header">
                            <h5 class="wow fadeInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
                                <img class="me-1" src="assets/images/icon/section-title.png" alt="icon">FROM OUR CASE studies
                        
                            </h5>
                            <h2 class="wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">We Delivered Best
                            Solution</h2>
                        </div>
                        <a href="case.html" class="btn-one wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                            view All
                        Case <i class="fa-regular fa-arrow-right-long"></i>
                        </a>
                    </div>
                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="case__item">
                                ...
                                <div class="case__content">
                                    ...
                                    <h3>
                                        <a href="case-details.html" class="text-white primary-hover">IT Management</a>
                                    </h3>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="case__item">
                                ...
                                <div class="case__content">
                                    ...
                                    <h3>
                                        <a href="case-details.html" class="text-white primary-hover">Platform
                                        Integration</a>
                                    </h3>
                                </div>
                                <a href="case-details.html" class="case__btn">
                        ...
                        <div class="swiper-slide">
                            <div class="case__item">
                                ...
                                <div class="case__content">
                                    <span class="primary-color sm-font">Solution</span>
                                    <h3>
                                        <a href="case-details.html" class="text-white primary-hover">Web Development</a>
                                    </h3>
                                </div>
                                <a href="case-details.html" class="case__btn">
                                    <i class="fa-regular fa-arrow-right"></i>
                        ...
                        <div class="swiper-slide">
                            <div class="case__item">
                                ...
                                <div class="case__content">
                                    ...
                                    <h3>
                                        <a href="case-details.html" class="text-white primary-hover">Network Security</a>
                                    </h3>
                                </div>
                                <a href="case-details.html" class="case__btn">
                                    <i class="fa-regular fa-arrow-right"></i>
            ...
            <section class="offer-area secondary-bg pt-120 pb-200">
                ...
                <div class="offer__shape-left">
                    <img class="wow fadeInUpBig" data-wow-delay="400ms" data-wow-duration="1500ms" src="assets/images/shape/offer-bg-shape-left.png" alt="shape">
                </div>
                <div class="offer__shape-right">
                    <img class="wow fadeInDownBig" data-wow-delay="400ms" data-wow-duration="1500ms" src="assets/images/shape/offer-bg-shape-right.png" alt="shape">
                </div>
                <div class="container">
                    <div class="d-flex gap-4 flex-wrap align-items-center justify-content-between mb-95">
                        <div class="section-header">
                            <h5 class="wow fadeInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
                                <img class="me-1" src="assets/images/icon/section-title.png" alt="icon">Our offering
                        
                            </h5>
                            <h2 class="text-white wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                                Enhance
                            and Pioneer Using <br>Technology Trends
                            </h2>
                        </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-6 wow bounceInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="offer__item">
                                <div class="shape-top">
                                    <img src="assets/images/shape/offter-item-shape-top.png" alt="shape">
                                </div>
            ...
            <section class="process-area pt-120 pb-120">
                <div class="container">
                    <div class="section-header text-center mb-60">
                        <h5 class="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <img class="me-1" src="assets/images/icon/section-title.png" alt="icon">Work Process
                    ...
                    <div class="row g-4">
                        <div class="col-lg-4 wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="process__item mb-100">
                                ...
                                <div class="process__content">
                                    <h4 class="mt-25 mb-10">Define Requirements
                                </h4>
                        ...
                        <div class="col-lg-4 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="process__item mb-100">
                                ...
                                <div class="process__content">
                                    <h4 class="mt-25 mb-10">Design & Prototyping
                                </h4>
                                    <p>In a free hour, when our power of choice is untrammelled and when nothing prevents
                                    dolor
                                    sit amet, consectetur</p>
                        ...
                        <div class="col-lg-4 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                            <div class="process__item">
                                ...
                                <div class="process__content">
                                    <h4 class="mt-25 mb-10">Finial Solution
                                </h4>
                                    <p>In a free hour, when our power of choice is untrammelled and when nothing prevents
                                    dolor
                                    sit amet, consectetur</p>
                ...
                <div class="container">
                    <div class="row g-4">
                        ...
                        <div class="col-lg-6 ps-2 ps-lg-5">
                            <div class="section-header mb-40">
                                <h5 class="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                                    <img class="me-1" src="assets/images/icon/section-title.png" alt="icon">CLIENTS REVIEW
            ...
            <section class="blog-area pt-120 pb-120">
                <div class="container">
                    <div class="section-header text-center mb-60">
                        <h5 class="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <img class="me-1" src="assets/images/icon/section-title.png" alt="icon">Blog & news
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="blog__item">
                                ...
                                <div class="blog__content">
                                    ...
                                    <h3>
                                        <a href="blog-details.html" class="primary-hover">Necessity May Give us Best Virtual
                                        Court</a>
                                    </h3>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="blog__item">
                                ...
                                <div class="blog__content">
                                    ...
                                    <h3>
                                        <a href="blog-details.html" class="primary-hover">Tackling the Changes of Retail
                                        Industry</a>
                                    </h3>
                                    <a class="mt-25 read-more-btn" href="blog-details.html">
                                        Read More <i class="fa-regular fa-arrow-right-long"></i>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                            <div class="blog__item">
                                ...
                                <div class="blog__content">
                                    ...
                                    <h3>
                                        <a href="blog-details.html" class="primary-hover">Easy and Most Powerful Server and
                                        Platform</a>
                                    </h3>
                                    <a class="mt-25 read-more-btn" href="blog-details.html">
                                        Read More <i class="fa-regular fa-arrow-right-long"></i>
