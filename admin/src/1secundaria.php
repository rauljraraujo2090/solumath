        ...
        <body>
            ...
            <div id="app">
                ...
                <div id="main">
                    ...
                    <section class="section">
                        <div class="card">
                            ...
                            $sqlAlumnos   = ("SELECT * FROM primer_secundaria ORDER BY id DESC");
              ...
              while ($dataAlumno = mysqli_fetch_array($queryAlumnos)) { ?>
                  ...
                  <td>
                  <a href="crud/detalles1secundaria.php?id=<?php echo $dataAlumno['id']; ?>" class="btn btn-warning mb-2"   title="Ver datos del alumno <?php echo $dataAlumno['namefull']; ?>">
                  <i class="bi bi-tv"></i> Ver</a>
                    <a href="crud/formEditar1secundaria.php?id=<?php echo $dataAlumno['id']; ?>" class="btn btn-info mb-2"   title="Actualizar datos del alumno <?php echo $dataAlumno['namefull']; ?>">
                    <i class="bi bi-arrow-clockwise"></i> Actualizar</a>
                    <a href="crud/eliminar_1secundaria.php?Id=<?php echo $dataAlumno['id']; ?>&metodo=3&namePhoto=<?php echo $dataAlumno['foto']; ?>" class="btn btn-danger mb-2" title="Borrar galeria <?php echo $dataAlumno['namefull']; ?>">
