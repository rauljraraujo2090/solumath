                                        ...
                                        <div class="row">
                                           ...
                                           // $result = mysqli_query($conn,$consulta);
                                            ...
                                            <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                                ...
                                                <h6 class="font-extrabold mb-0"><?php echo $contar ?></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                                <h6 class="text-muted font-semibold"><a href="https://www.youtube.com/watch?v=rFssfx37UJw">Mensajes</a></h6>
                            ...
                            <div class="card-body py-4 px-4">
                                <div class="d-flex align-items-center">
                                    <div class="avatar avatar-xl">
                                        <img src="raul.jpg" alt="Face 1">
                                    </div>
                                    <div class="ms-3 name">
                                        <h5 class="font-bold">Raul Jr</h5>
                                        <h6 class="text-muted mb-0">@raul jr</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
