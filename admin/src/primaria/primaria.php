                        ...
                        <div class="page-title">
                            <div class="row">
                                <div class="col-12 col-md-6 order-md-1 order-last">
                                    <h3>Bienvenido</h3>
                                    <p class="text-subtitle text-muted">Aqui podras registrar todos los contenidos para el sitio web.</p>
                                </div>
                                    ...
                                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="myModalLabel1">Registrar Video Primer Grado</h5>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="card">
                                                                ...
                                                                <div class="card-content">
                                                                    <div class="card-body">
                                                                        <form class="form" action="insertar_primaria.php" method="post" enctype="multipart/form-data">
                                                                            <div class="row">
                                                                            ...
                                                                            <div class="col-md-12 col-12">
                                                                                    <div class="form-group">
                                                                                        <label for="first-name-column">descripcion</label>
                                                                                        <input type="text" name="titulo" id="first-name-column" class="form-control" placeholder="First Name"  required="">
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="col-md-12 col-12">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="file" name="imagen" id="first-name-column" class="form-control" placeholder="First Name" >
                                                                                    </div>
                                                                                </div>
                                                                              ...
                                                                              <div class="col-md-6 col-12">
                                                                                ...
                                                                                <div class="col-12 d-flex justify-content-end">
                                                                                    <button type="submit" class="btn btn-primary me-1 mb-1"value="Guardar" name="Guardar" >Registrar</button>
                                         ...
                                         //include('operaciones/modal_editar.php');
                                            ...
                                            while ($raul = mysqli_fetch_array($sql)){ 
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $raul['descripcion']; ?></td>
                                                    <td><img src="img/<?php echo $raul['img']; ?>" ></td>
