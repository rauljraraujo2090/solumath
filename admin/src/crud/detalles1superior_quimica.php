...
<head>
    ...
    <title>detalles de quimica</title>
...
<div class="container mt-3">
  <div class="row justify-content-md-center">
    <div class="col-md-12">
      <h1 class="text-center mt-3">Detalles de quimica superior </h1>
      <hr class="mb-3">
    </div>
    <style>
  p{
...
<?php
    ...
    $sqlAlumnos   = ("SELECT * FROM quimica_superior WHERE id='$idAlumno' LIMIT 1");
 ...
 <?php
    ...
    <div class="card" style="width: 30rem;">
        ...
        <div class="d-grid gap-2 col-12 mx-auto">
            <a href="../quimica_superior.php" class="btn btn-primary mt-3 mb-2">
