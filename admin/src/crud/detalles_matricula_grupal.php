...
<head>
    ...
    <title>detalles matricula Grupal</title>
...
<div class="container mt-3">
  <div class="row justify-content-md-center">
    <div class="col-md-12">
      <h1 class="text-center mt-3">detalles matricula Grupal</h1>
      <hr class="mb-3">
    </div>
...
<?php
    ...
    $sqlAlumnos   = ("SELECT * FROM matricula_grupal WHERE id='$idAlumno' LIMIT 1");
 ...
 <?php
    ...
    <div class="card" style="width: 30rem;">
        ...
        <div class="d-grid gap-2 col-12 mx-auto">
            <a href="../matricula_grupal.php" class="btn btn-primary mt-3 mb-2">
