...
<head>
    ...
    <title>detalles de 4 Grado</title>
...
<div class="container mt-3">
  <div class="row justify-content-md-center">
    <div class="col-md-12">
      <h1 class="text-center mt-3">Detalles de 4 secundaria </h1>
      <hr class="mb-3">
    </div>
...
<?php
    ...
    $sqlAlumnos   = ("SELECT * FROM cuarto_secundaria WHERE id='$idAlumno' LIMIT 1");
 ...
 <?php
    ...
    <div class="card" style="width: 30rem;">
        ...
        <div class="d-grid gap-2 col-12 mx-auto">
            <a href="../4secundaria.php" class="btn btn-primary mt-3 mb-2">
