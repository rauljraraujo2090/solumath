...
<head>
    ...
    <title>Editar estadistica superior</title>
...
<div class="container mt-3">
  <div class="row justify-content-md-center">
    ...
    $sqlAlumnos   = ("SELECT * FROM estadistica_superior WHERE id='$idAlumno' LIMIT 1");
    ...
    <div class="col-md-5 mb-3">
      ...
      <form method="POST" action="action1superior_estadistica.php?metodo=2" enctype="multipart/form-data">
    ...
    <div class="col-md-5 mb-3">
        <label class="form-label">Foto actual de la galerias</label>
        <br>
