  ...
  <div class="row justify-content-md-center">
    <div class="col-md-12">
      <h1 class="text-center mt-3">
        ...
        Actualizar Datos  de la Galeria
      </h1>
      <hr class="mb-3">
    </div>
    ...
    $sqlAlumnos   = ("SELECT * FROM galerias WHERE id='$idAlumno' LIMIT 1");
    ...
    <div class="col-md-5 mb-3">
      ...
      <form method="POST" action="actiongaleria.php?metodo=2" enctype="multipart/form-data">
    ...
    <div class="col-md-5 mb-3">
        ...
        <br>
        <img src="img_galerias/<?php echo $dataAlumno['foto']; ?>" alt="foto perfil" class="card-img-top fotoPerfil">
    </div>
