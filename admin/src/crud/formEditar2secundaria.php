...
<head>
    ...
    <title>Editar 2 secundaria</title>
...
<div class="container mt-3">
  <div class="row justify-content-md-center">
    ...
    $sqlAlumnos   = ("SELECT * FROM segundo_secundaria WHERE id='$idAlumno' LIMIT 1");
    $queryAlumnos = mysqli_query($con, $sqlAlumnos);
    $dataAlumno   = mysqli_fetch_array($queryAlumnos);
    ?>

    <div class="col-md-5 mb-3">
      <h3 class="text-center">2do grado Secundaria</h3>
      <form method="POST" action="action2secundaria.php?metodo=2" enctype="multipart/form-data">
