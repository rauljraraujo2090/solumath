...
<head>
    ...
    <title>Editar 1 secundaria</title>
...
<div class="container mt-3">
  <div class="row justify-content-md-center">
    ...
    <div class="col-md-5 mb-3">
      <h3 class="text-center">1er grado Secundaria</h3>
      <form method="POST" action="action1secundaria.php?metodo=2" enctype="multipart/form-data">
