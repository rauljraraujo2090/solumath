...
<head>
    ...
    <title>detalles matricula Individual</title>
...
<div class="container mt-3">
  <div class="row justify-content-md-center">
    <div class="col-md-12">
      <h1 class="text-center mt-3">detalles matricula Individual </h1>
      <hr class="mb-3">
    </div>
 ...
 <?php
    ...
    <div class="card" style="width: 30rem;">
        ...
        <div class="d-grid gap-2 col-12 mx-auto">
            <a href="../matricula_individual.php" class="btn btn-primary mt-3 mb-2">
