...
<head>
    ...
    <title>Editar Sobre Solumath </title>
...
<div class="container mt-3">
  <div class="row justify-content-md-center">
    ...
    $sqlAlumnos   = ("SELECT * FROM sobre_sulemath WHERE id='$idAlumno' LIMIT 1");
    $queryAlumnos = mysqli_query($con, $sqlAlumnos);
    $dataAlumno   = mysqli_fetch_array($queryAlumnos);
    ?>

    <div class="col-md-5 mb-3">
      <h3 class="text-center">Sobre solumath</h3>
      <form method="POST" action="action_sobre_sulemath.php?metodo=2" enctype="multipart/form-data">
    ...
    <div class="col-md-5 mb-3">
        <label class="form-label">Foto actual de  sobre solumath</label>
        <br>
