...
<div class="container mt-3">
  <div class="row justify-content-md-center">
    ...
    $sqlAlumnos   = ("SELECT * FROM quinto_grado WHERE id='$idAlumno' LIMIT 1");
    $queryAlumnos = mysqli_query($con, $sqlAlumnos);
    $dataAlumno   = mysqli_fetch_array($queryAlumnos);
    ?>

    <div class="col-md-5 mb-3">
      <h3 class="text-center">5to grado Primaria</h3>
      <form method="POST" action="action5grado.php?metodo=2" enctype="multipart/form-data">
