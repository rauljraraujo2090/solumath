            ...
            <div id="app">
                        ...
                        <div class="col-12 col-md-12 col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="excel_grupal.php" type="button" class="btn icon icon-left btn-primary" ><i data-feather="user"></i>
                                            General excel
                                        </a>
                                        <!----
                    ...
                    <section class="section">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title">
                                    Lista de de matriculados Grupalmente
                                </h5>
                            </div>

                            <?php
                            include('crud/config.php');
                            $sqlAlumnos   = ("SELECT * FROM matricula_grupal ORDER BY id DESC");
              ...
              while ($dataAlumno = mysqli_fetch_array($queryAlumnos)) { ?>
                  ...
                  <i class="bi bi-tv"></i> Ver</a>
                    ...
                    <a href="crud/eliminar_matricula_grupal.php?Id=<?php echo $dataAlumno['id']; ?>&metodo=3&namePhoto=<?php echo $dataAlumno['foto']; ?>" class="btn btn-danger mb-2" title="Borrar galeria <?php echo $dataAlumno['namefull']; ?>">
