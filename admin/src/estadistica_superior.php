        ...
        <body>
            ...
            <div id="app">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="card">
                                                                ...
                                                                <div class="card-content">
                                                                    <div class="card-body">
                                                                        <form class="form" method="POST" action="crud/action1superior_estadistica.php" enctype="multipart/form-data">
                    ...
                    <section class="section">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title">
                                    Lista  de estadistica superior
                                </h5>
                            </div>

                            <?php
                            include('crud/config.php');
                            $sqlAlumnos   = ("SELECT * FROM estadistica_superior ORDER BY id DESC");
              ...
              while ($dataAlumno = mysqli_fetch_array($queryAlumnos)) { ?>
                  ...
                  <td>
                  <a href="crud/detalles1superior_estadistica.php?id=<?php echo $dataAlumno['id']; ?>" class="btn btn-warning mb-2"   title="Ver datos del alumno <?php echo $dataAlumno['namefull']; ?>">
                  <i class="bi bi-tv"></i> Ver</a>
                    <a href="crud/formEditar1superior_estadistica.php?id=<?php echo $dataAlumno['id']; ?>" class="btn btn-info mb-2"   title="Actualizar datos del alumno <?php echo $dataAlumno['namefull']; ?>">
                    <i class="bi bi-arrow-clockwise"></i> Actualizar</a>
                    <a href="crud/eliminar_estadistica.php?Id=<?php echo $dataAlumno['id']; ?>&metodo=3&namePhoto=<?php echo $dataAlumno['foto']; ?>" class="btn btn-danger mb-2" title="Borrar galeria <?php echo $dataAlumno['namefull']; ?>">
