        ...
        <body>
            ...
            <div id="app">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="card">
                                                                ...
                                                                <div class="card-content">
                                                                    <div class="card-body">
                                                                        <form class="form" method="POST" action="crud/action1grado.php" enctype="multipart/form-data">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="buttons">
                                        ...
                                        <a href="excel_individual.php" type="button" class="btn icon icon-left btn-primary" ><i data-feather="user"></i>
                                            Generar excel
                                        </a>
                                        <!----
                    ...
                    <section class="section">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title">
                                    Lista de de matriculados Individualmente
                                </h5>
                            </div>

                            <?php
                            include('crud/config.php');
                            $sqlAlumnos   = ("SELECT * FROM matricula_individual ORDER BY id DESC");
                                    ...
                                    <table class="table tag" id="table1">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">colegio Procedencia</th>
                                                <th scope="col">Grado</th>
                                                <th scope="col">Dni</th>
                                                <th scope="col">Fecha Nacimiento</th>
                                                <th scope="col">Contacto</th>
                                                <th scope="col">Correo</th>
                                                <th scope="col">Matriculado a</th>
              ...
              while ($dataAlumno = mysqli_fetch_array($queryAlumnos)) { ?>
                  ...
                  <td><?php echo $dataAlumno['a_paterno']; ?></td>
                  <td><?php echo $dataAlumno['a_materno']; ?></td>
                  <td><?php echo $dataAlumno['namefull']; ?></td>
                  <td><?php echo $dataAlumno['direccion']; ?></td>
                  <td><?php echo $dataAlumno['procedencia_c']; ?></td>
                  <td><?php echo $dataAlumno['grado']; ?></td>
                  <td><?php echo $dataAlumno['dni']; ?></td>

                  <td><?php echo $dataAlumno['fecha_nacimiento']; ?></td>
                  <td><?php echo $dataAlumno['celular']; ?></td>
                  <td><?php echo $dataAlumno['correo']; ?></td>
                  <td><?php echo $dataAlumno['me_matriculo']; ?></td>
                  <td><?php echo $dataAlumno['foto']; ?></td>
                  
                  
                  <td>
                  <a href="crud/detalles_matricula_individual.php?id=<?php echo $dataAlumno['id']; ?>" class="btn btn-warning mb-2"   title="Ver datos del alumno <?php echo $dataAlumno['namefull']; ?>">
                  <i class="bi bi-tv"></i> Ver</a>
                   
                    <a href="crud/eliminar_matricula_individual.php?Id=<?php echo $dataAlumno['id']; ?>&metodo=3&namePhoto=<?php echo $dataAlumno['foto']; ?>" class="btn btn-danger mb-2" title="Borrar galeria <?php echo $dataAlumno['namefull']; ?>">
