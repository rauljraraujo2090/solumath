            ...
            <div class="card-body">
              ...
              <form action="validar.php"  method="post">
                  <div class="form-group">
                    ...
                    <input type="text" name="usuarios" id="email" class="form-control" placeholder="Ingrese su usuario">
                  </div>
                ...
                <a href="#!" class="forgot-password-link">Cualquier duda o consulta </a>
                <p class="login-card-footer-text">comunicate con soporte  <a href="#!" class="text-reset">904240525</a></p>
