        ...
        <body>
            ...
            <div id="app">
                ...
                <div id="main">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="card">
                                                                ...
                                                                <div class="card-content">
                                                                    <div class="card-body">
                                                                        <form class="form" method="POST" action="crud/action5secundaria.php" enctype="multipart/form-data">
                    ...
                    <section class="section">
                        <div class="card">
                            ...
                            $sqlAlumnos   = ("SELECT * FROM quinto_secundaria ORDER BY id DESC");
              ...
              while ($dataAlumno = mysqli_fetch_array($queryAlumnos)) { ?>
                  ...
                  <td>
                  <a href="crud/detalles5secundaria.php?id=<?php echo $dataAlumno['id']; ?>" class="btn btn-warning mb-2"   title="Ver datos del alumno <?php echo $dataAlumno['namefull']; ?>">
                  <i class="bi bi-tv"></i> Ver</a>
                    <a href="crud/formEditar5secundaria.php?id=<?php echo $dataAlumno['id']; ?>" class="btn btn-info mb-2"   title="Actualizar datos del alumno <?php echo $dataAlumno['namefull']; ?>">
                    <i class="bi bi-arrow-clockwise"></i> Actualizar</a>
                    <a href="crud/eliminar_5secundaria.php?Id=<?php echo $dataAlumno['id']; ?>&metodo=3&namePhoto=<?php echo $dataAlumno['foto']; ?>" class="btn btn-danger mb-2" title="Borrar galeria <?php echo $dataAlumno['namefull']; ?>">
