...
$seleccionar="SELECT * FROM usuario  WHERE id=$id_usuario";
...
<!---MODAL PARA EDITAR -->
 ...
 <div class="col-md-6 col-12">
     <div class="card">
         ...
         <!--Basic Modal -->
         <div class="modal fade text-left" id="modal_editar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
