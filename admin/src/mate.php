                                ...
                                <div class="col-12 col-md-6 order-md-2 order-first">
                                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">tabla-1</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                                    ...
                                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="myModalLabel1">Registrar videos para primaria</h5>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="card">
                                                                ...
                                                                <div class="card-content">
                                                                    <div class="card-body">
                                                                    <form class="form"  enctype="multipart/form-data" action="operaciones/insertar1copy.php" method="POST">
                                                                            <div class="row">
                                                                            
                                                                                <div class="col-md-6 col-12">
                                                                                    <div class="form-group">
                                                                                        <label for="first-name-column">Imagen</label>
                                                                                        <input type="file" accept="video/*"id="first-name-column" class="form-control"  placeholder="Imagen" name="foto">
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="col-md-6 col-12">
                                                                                    <div class="form-group">
                                                                                        <label for="last-name-column">Nombre</label>
                                                                                        <input type="text" id="last-name-column" class="form-control" placeholder="Last Name" name="nombre">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-6 col-12">
                                                                                    <div class="form-group">
                                                                                        <label for="city-column">Descripcion</label>
                                                                                        <input type="text" id="city-column" class="form-control" placeholder="descripcion" name="descripcion">
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="col-12 d-flex justify-content-end">
                                                                                    <button type="submit" name="btn" class="btn btn-primary me-1 mb-1">Registrar</button>
                                    ...
                                    <table class="table tag" id="table1">
                                        ...
                                        <tbody>
                                         ...
                                         //include('operaciones/modal_editar.php');
                                            $mostrar="Select*from primaria";
                                            $query=$DB_con->prepare($mostrar);
                                            $query->execute();
