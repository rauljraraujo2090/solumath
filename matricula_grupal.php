...
?>
        ...
        <div class="col-lg-6 ps-2 ps-lg-5">
                            <div class="section-header mb-40">
                                ...
                                <h2 class="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">Matricula Grupal</h2>
                                <p class="wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">Para matricular estudiantes Individualmente click en el siguiente boton</p>
                            </div>
                            <a class="wow fadeInUp btn-one mt-0"  data-delay="1s" href="matricula_individual.php">Matricula Individual <i class="fa-regular fa-arrow-right-long"></i></a>
                        ...
                        <div class="col-lg-12 wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="talk-us__item">
                                <div class="section-header mb-30">
                                    ...
                                    <center>
                                    <h2 class="text-white">¡Datos del Docente!</h2>
</center>
